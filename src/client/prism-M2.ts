...
export default // Auto-generated for Macaulay2-1.19.1.1. Do not modify this file manually.
[
  "about",
  "abs",
...
Prism.languages.m2 = Prism.languages.macaulay2 = {
  comment: [
    {
      pattern: /(^|[^\\])\-\*[\s\S]*?(?:\*\-|$)/,
      lookbehind: true,
